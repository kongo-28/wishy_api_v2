...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference("Wish.count") do
      post wishes_url, params: { wish: { content: @wish.content, title: @wish.title } }, as: :json
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { content: @wish.content, title: @wish.title } }, as: :json
    assert_response :success
  end
